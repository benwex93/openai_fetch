...
COPY ./fetch.gazebo.xacro /opt/ros/melodic/share/fetch_gazebo/robots
# COPY ./base.xacro /ros_ws/src/fetch_simple_simulation/fetch_simple_description/robot/base.xacro
