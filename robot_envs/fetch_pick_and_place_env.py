...
from fetch_train.srv import JointTraj, JointTrajRequest


class RetchPickAndPlace(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self):
        ...
        JOINT_STATES_SUBSCRIBER = '/fetch/joint_states'
        ...
        super(MyFetchEnv, self).__init__(controllers_list=self.controllers_list,
    ...
    def _check_joint_states_ready(self):
        ...
        #     try:
        #         self.joints = rospy.wait_for_message("/fetch/joint_states", JointState, timeout=1.0)
        #         rospy.logdebug("Current /fetch/joint_states READY=>" + str(self.joints))

        #     except:
        #         rospy.logerr("Current /fetch/joint_states not ready yet, retrying for getting /fetch/joint_states")
        # return self.joints
        pass
    ...
    def set_init_trajectory_joints(self, initial_qpos):
        """
        Helper function.
        Wraps an action vector of joint angles into a JointTrajectory message.
        The velocities, accelerations, and effort do not control the arm motion
    ...
    def set_trajectory_joints(self, joints_action):
        """
        Helper function.
        Wraps an action vector of joint angles into a JointTrajectory message.
        The velocities, accelerations, and effort do not control the arm motion
        ...
        joint_point.point.positions = [None] * 7
        joint_point.point.positions[0] = joints_action["joint0"]
        joint_point.point.positions[1] = joints_action["joint1"]
        joint_point.point.positions[2] = joints_action["joint2"]
        joint_point.point.positions[3] = joints_action["joint3"]
        joint_point.point.positions[4] = joints_action["joint4"]
        joint_point.point.positions[5] = joints_action["joint5"]
        joint_point.point.positions[6] = joints_action["joint6"]
